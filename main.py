...
# trích xuất đặc trưng và tìm kiếm điểm đặc trưng giữa hai hình ảnh sử dụng thuật toán SIFT (Scale-Invariant Feature Transform)
# và bộ so khớp FLANN (Fast Library for Approximate Nearest Neighbors).
